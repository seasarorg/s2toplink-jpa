 ...
 *
 */
public class S2ServerPlatformForTestTest extends S2TestCase {

    private S2ServerPlatformForTest serverPlatform = new S2ServerPlatformForTest(null);
    ...
    public void testGetExternalTransactionControllerClass() {
        assertEquals(S2TransactionControllerForTest.class, serverPlatform.getExternalTransactionControllerClass());
    }
